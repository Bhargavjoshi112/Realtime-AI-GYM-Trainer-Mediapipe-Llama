...
PROMPT = (
    ...
    "5. Speak like a real coach giving voice instructions.\n"
    "6. DO NOT include quotation marks, labels, or narration.\n"
    "7. NEVER use words like 'quote', 'unquote', or formatting indicators.\n"
    "8. Output ONLY the spoken sentence, nothing else.\n\n"
